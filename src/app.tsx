...
export const App = () => {
  ...
  return (
    <div className="bg-red-900 min-h-screen text-white p-6">
      <div className="max-w-3xl mx-4 bg-red-800 rounded-xl shadow-lg p-6">
        ...
        <section className="mb-8">
          ...
          <p className="text-yellow-200 font-inter text-base leading-relaxed">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="flex items-center p-4 border border-yellow-300 rounded-lg">
              ...
              <div>
                ...
                <p className="text-yellow-200 text-sm">5'4"</p>
              </div>
            </div>
            <div className="flex items-center p-4 border border-yellow-300 rounded-lg">
              <svg className="w-6 h-6 text-yellow-300 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <p className="text-yellow-200 text-sm">Chips and Guacamole</p>
              </div>
            </div>
            <div className="flex items-center p-4 border border-yellow-300 rounded-lg">
              <svg className="w-6 h-6 text-yellow-300 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div>
                ...
                <p className="text-yellow-200 text-sm">1 sister, Sarah. We fight a lot but love each other deeply.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-yellow-200 font-inter text-sm space-y-2">
