          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                Hey there! I'm Ming Tan, a Malaysian chef with over 12 years in the kitchen. I'm all about cooking up authentic, flavor-packed dishes and working with awesome teams. I've had the chance to work with big names like Gordon Ramsay and Bobby Flay, and I'm always stoked to bring fresh ideas to the kitchen. 🍲✨
              </p>
            </section>
