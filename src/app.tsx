  ...
  return (
    <div className="bg-purple-50 min-h-screen text-gray-900 font-sans">
      ...
      <div className="text-center mt-4 mb-2">
        <h1 className="text-3xl font-bold text-purple-800">Vibe Voice App</h1>
      </div>
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-2 text-xs text-gray-700">
                <div className="flex items-center gap-1">
                  ...
                  <span className="font-bold text-xs mb-1">123 Main Street, Chicago, IL 60601</span>
                </div>
                <div className="flex items-center gap-1">
                  <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="w-full md:w-2/3 space-y-4">
            ...
            <section>
              ...
              <div className="mb-2 p-3 bg-gray-50 rounded-lg transition-colors duration-200 hover:bg-gray-100">
                ...
                <ul className="list-disc list-inside text-gray-700 ml-4 space-y-0.5 text-xs">
              ...
              <div className="mb-2 p-3 bg-gray-50 rounded-lg transition-colors duration-200 hover:bg-gray-100">
                <h3 className="text-lg font-semibold text-gray-800">Executive Chef</h3>
            ...
            {/* Collaborations */}
            <section className="transition-all duration-300 hover:scale-[1.003]">
              <h2 className="text-xl font-bold text-purple-600 mb-1">Notable Collaborations</h2>
              <ul className="list-disc list-inside text-gray-700 ml-4 space-y-0.5 text-xs">
            ...
            {/* Skills */}
            <section>
              <h2 className="text-xl font-bold text-purple-600 mb-1">Skills</h2>
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-purple-50 p-2 rounded-md transition-transform duration-200 hover:scale-100">
            ...
            {/* Education */}
            <section className="transition-all duration-300 hover:scale-[1.003]">
              <h2 className="text-xl font-bold text-purple-600 mb-1">Education</h2>
            ...
            {/* Sign Up Section */}
            <section>
              <h2 className="text-xl font-bold text-purple-600 mb-1">Join the Holiday Feast</h2>
              <div className="bg-purple-50 p-4 rounded-lg shadow-md max-w-md mx-auto transition-all duration-300 hover:shadow-md">
                <form>
                  <div className="mb-2">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      className="w-full px-2 py-1 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 text-xs"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-purple-600 text-white py-1 px-3 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 transform hover:scale-100 shadow-sm hover:shadow text-xs"
                  >
