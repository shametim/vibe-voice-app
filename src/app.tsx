      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8">
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-100 p-4 rounded-lg">
            ...
            <p className="text-gray-600">DMD Candidate, Class of 2025</p>
            <p className="text-gray-500 text-sm mt-1">Specializing in Pediatric Dentistry</p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-600 font-inter space-y-2">
