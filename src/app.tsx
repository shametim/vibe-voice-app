...
export const App = () => {
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans">
      {/* New Hero Section */}
      <div className="bg-orange-600 text-white p-6 md:p-8 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-orange-600 mb-2">About Me</h2>
            ...
            {/* Work Experience */}
            <section>
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Work Experience</h2>
            ...
            {/* Collaborations */}
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Notable Collaborations</h2>
              <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1 text-sm">
            ...
            {/* Skills */}
            <section>
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Skills</h2>
            ...
            {/* Education */}
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Education</h2>
            ...
            {/* Sign Up Section */}
            <section>
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Join the Holiday Feast</h2>
                ...
                <form>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 transition-all duration-200"
