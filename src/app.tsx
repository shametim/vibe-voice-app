...
export const App = () => {
  return (
    <div className="bg-purple-50 min-h-screen text-gray-900 font-sans">
      {/* New Hero Section */}
      <div className="bg-purple-600 text-white p-6 md:p-8 text-center">
        <h1 className="text-3xl md:text-4xl font-bold">Hiya! I'm Amy</h1>
      ...
      <div className="text-center mt-8 mb-4">
        <h1 className="text-4xl font-bold text-purple-800">Vibe Voice App</h1>
      </div>

      <div className="max-w-4xl mx-auto p-6 md:p-8">
        <div className="flex flex-col md:flex-row gap-6">
          {/* Sidebar - Contact Info */}
          <div className="w-full md:w-1/3 bg-purple-100 p-5 rounded-lg shadow-md transition-shadow duration-300 hover:shadow-lg">
            <div className="text-center md:text-left">
              <a href="#top" className="text-4xl font-bold text-purple-600 drop-shadow-sm mb-2 block transition-colors duration-200 hover:text-purple-500">Amy</a>
          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-purple-600 mb-2">About Me</h2>
            ...
            {/* Work Experience */}
            <section>
              <h2 className="text-2xl font-bold text-purple-600 mb-2">Work Experience</h2>
            ...
            {/* Collaborations */}
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-purple-600 mb-2">Notable Collaborations</h2>
              <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1 text-sm">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-purple-50 p-3 rounded-md transition-transform duration-200 hover:scale-105">
            ...
            {/* Education */}
            <section className="transition-all duration-300 hover:scale-[1.005]">
              <h2 className="text-2xl font-bold text-purple-600 mb-2">Education</h2>
            ...
            {/* Sign Up Section */}
            <section>
              <h2 className="text-2xl font-bold text-purple-600 mb-2">Join the Holiday Feast</h2>
              <div className="bg-purple-50 p-6 rounded-lg shadow-md max-w-md mx-auto transition-all duration-300 hover:shadow-xl">
                <form>
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
                  >
