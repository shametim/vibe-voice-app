        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/3 bg-gray-50 p-6 rounded-lg shadow-md">
            <div className="text-center md:text-left">
              <h1 className="text-3xl font-bold text-pink-500 mb-2">Ming Tan</h1>
              <p className="text-gray-600 mb-4">Head Chef | Malaysian Cuisine Specialist</p>
          ...
          <div className="w-full md:w-2/3 space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-pink-500 mb-3">Professional Summary</h2>
            ...
            {/* Experience */}
            <section>
              <h2 className="text-2xl font-bold text-pink-500 mb-3">Professional Experience</h2>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 mb-2">Rasa Nusantara, Penang • 2012 - 2018</p>
                <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
            ...
            {/* Skills */}
            <section>
              <h2 className="text-2xl font-bold text-pink-500 mb-3">Skills</h2>
            ...
            {/* Education */}
            <section>
              <h2 className="text-2xl font-bold text-pink-500 mb-3">Education</h2>
