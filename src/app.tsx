          ...
          <div className="w-full md:w-2/3 space-y-6">
            ...
            <section className="transition-all duration-300 hover:scale-[1.005]">
              ...
              <p className="text-gray-700 leading-relaxed">
                Hey there! I'm Ming, a Malaysian chef with over 10 years in the kitchen. I love cooking up tasty dishes and working with awesome teams. I've worked with big names like Gordon Ramsay and Bobby Flay, and I'm always excited to bring fresh ideas to the kitchen. Let's cook up some awesome meals together! 🍲✨
              </p>
            </section>
