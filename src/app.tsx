export const App = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-amber-50 text-gray-900 shadow-xl rounded-xl transition-all duration-300 hover:shadow-2xl relative flex flex-row">
      {/* Left Half: Vibe Voice App */}
      <div className="w-1/2">
