      ...
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-md p-8">
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-2">
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">JavaScript</span>
            ...
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">Node.js</span>
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">Python</span>
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">Django</span>
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">SQL</span>
            <span className="bg-gray-100 text-gray-800 px-3 py-1 rounded">Git</span>
          </div>
        </section>
      </div>
    </div>
